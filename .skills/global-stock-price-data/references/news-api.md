...
**Endpoint:** `GET https://app-c923a5as1gxt-api-AalZze1qEWML.gateway.appmedo.com/v1/news/all`
...
async function getFinanceNews(params: NewsParams = {}): Promise<NewsResponse> {
  ...
  const response = await fetch(
    `https://app-c923a5as1gxt-api-AalZze1qEWML.gateway.appmedo.com/v1/news/all?${query.toString()}`,
