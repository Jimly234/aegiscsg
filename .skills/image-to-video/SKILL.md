...
| Item | Details |
|------|---------|
| Submit endpoint | `POST https://app-c923a5as1gxt-api-rY7JZvg0dqdL.gateway.appmedo.com/v1/videos/image2video` |
| Query endpoint | `GET https://app-c923a5as1gxt-api-oYA6Z8wDBRDa.gateway.appmedo.com/v1/videos/image2video/{id}` |
